...
function getAnimeCallback(response)
{
    if(search)
    {
        ...
        elem = document.getElementById("animes");
        elem.innerHTML = "";
    ...
    children.innerHTML += "<div class=\"cell answers\"><div class=\"input-control text\" style=\"width:100%\"><input type=\"number\" id=\"rating\" min=\"1\" max=\"10\"></div><button class=\"button color-quest\" onclick=\"addAnime\">Add to list</button></div>";
}
